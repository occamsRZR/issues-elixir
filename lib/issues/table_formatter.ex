defmodule Issues.TableFormatter do
	...
	and these columns are extracted and printed from the rows.
  ...
  ## Example
   ...
   """
	...
	## Example
     ...
     iex> Issues.TableFormatter.max_column_widths(data)
     [ 6, 8 ]
	"""
  ...
  Generate the line that goes below the column headings.  It is a string of
	hyphens, with + signs where the verticle bar between the column goes.
